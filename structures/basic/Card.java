...
public class Card {
	...
	public boolean hasRush() { return this.cardname.equals("Saberspine Tiger");} // setting so that the saperspine tiger can use Rush
	public boolean hasFlying() { return this.cardname.equals("Young Flamewing");} // same with flying ability
